...
var alpha = __assign(__assign({}, number), { transform: clamp3(0, 1) });
...
var MotionValue = class {
  ...
  scheduleVelocityCheck = () => sync2.postRender(this.velocityCheck);
...
var alpha2 = __assign2(__assign2({}, number2), { transform: clamp4(0, 1) });
var scale2 = __assign2(__assign2({}, number2), { default: 1 });
...
var progressPercentage2 = __assign2(__assign2({}, percent2), { parse: function(v) {
...
var rgbUnit2 = __assign2(__assign2({}, number2), { transform: function(v) {
...
var filter2 = __assign2(__assign2({}, complex2), { getAnimatableNone: function(v) {
