...
var InlineAtRule = function(_super) {
  ...
  InlineAtRule2.prototype.build = function() {
    return this.value ? "@" + this.name + " " + this.value + (this.important ? " !important" : "") + ";" : "@" + this.name + (this.important ? " !important" : "") + ";";
  };
  ...
  Object.defineProperty(Style2.prototype, "rule", {
    get: function() {
      ...
      this._parentSelectors && (selectors = selectors.map(function(i) {
        var _a2;
        return ((_a2 = _this._parentSelectors) === null || _a2 === void 0 ? void 0 : _a2.join(" ")) + " " + i;
      }));
      ...
      this._pseudoClasses && (selectors = selectors.map(function(i) {
        var _a2;
        return i + (":" + ((_a2 = _this._pseudoClasses) === null || _a2 === void 0 ? void 0 : _a2.join(":")));
      }));
      this._pseudoElements && (selectors = selectors.map(function(i) {
        var _a2;
        return i + ("::" + ((_a2 = _this._pseudoElements) === null || _a2 === void 0 ? void 0 : _a2.join("::")));
      }));
      this._brotherSelectors && (selectors = selectors.map(function(i) {
        var _a2;
        return i + ("." + ((_a2 = _this._brotherSelectors) === null || _a2 === void 0 ? void 0 : _a2.join(".")));
      }));
      this._childSelectors && (selectors = selectors.map(function(i) {
        var _a2;
        return i + (" " + ((_a2 = _this._childSelectors) === null || _a2 === void 0 ? void 0 : _a2.join(" ")));
      }));
  ...
  Style2.generate = function(parent, property, root) {
    ...
    var _loop_1 = function(key2, value2) {
      if (typeof value2 === "string") {
        root.add(new Property(camelToDash(key2), value2));
      } else if (Array.isArray(value2)) {
        value2.map(function(i) {
          ...
          if (wrap.selector === void 0) {
            ...
            if (/^[a-z]+$/.test(key2) && !isTagName(key2)) {
              wrap.wrapProperty(function(property2) {
                return key2 + "-" + property2;
              });
              child = wrap;
            } else {
              var _hKey_1 = function(selector, key3) {
                return (/&/.test(key3) ? key3 : "& " + key3).replace("&", selector);
              };
        ...
        output = output.concat(Style2.generate(key2.startsWith("@") ? void 0 : key2, value2, child));
      }
    };
  ...
  Style2.prototype.build = function(minify, prefixer) {
    ...
    if (this.atRules) {
      for (var _i = 0, _a = this.atRules; _i < _a.length; _i++) {
        var rule = _a[_i];
        result = minify ? "" + rule.replace(/\s/g, "") + wrapit(result, void 0, void 0, void 0, minify) : rule + " " + wrapit(result, void 0, void 0, void 0, result !== "" ? minify : true);
      }
    }
...
var Keyframes = function(_super) {
  ...
  Keyframes2.generate = function(name, children, root, prefixer) {
    ...
    for (var _i = 0, _a = Object.entries(children); _i < _a.length; _i++) {
      var _b = _a[_i], key = _b[0], value = _b[1];
      var style = new Keyframes2(key).atRule("@keyframes " + name);
      var webkitStyle = new Keyframes2(key).atRule("@-webkit-keyframes " + name);
...
function _buildAtrule(atrule, children, minify, prefixer) {
  ...
  return "" + atrule + (minify ? "" : " ") + wrapit(_buildStyleList(children, minify, prefixer), void 0, void 0, void 0, minify);
}
...
function negative(scale2) {
  return Object.keys(scale2).filter(function(key) {
    ...
    var _a;
    return __assign(__assign({}, negativeScale), (_a = {}, _a["-" + key] = negateValue(scale2[key]), _a));
  }, {});
}
function breakpoints(screens) {
  ...
  return Object.keys(screens).filter(function(key) {
    ...
    var _a;
    return __assign(__assign({}, breakpoints2), (_a = {}, _a["screen-" + key] = screens[key], _a));
  }, {});
}
...
function generateScreens(screens) {
  ...
  breakpoints2.forEach(function(_a, index) {
    ...
    if (isString(size2)) {
      ...
      variants["<" + name] = styleForBreakpoint({ max: increaseWithUnit(size2, -0.1) });
      variants["@" + name] = styleForBreakpoint(nextSize ? { min: size2, max: increaseWithUnit(nextSize, -0.1) } : { min: size2 });
      variants["-" + name] = styleForBreakpoint({ max: size2 });
      variants["+" + name] = styleForBreakpoint(nextSize ? { min: size2, max: nextSize } : { min: size2 });
    } else {
  ...
  var states = {
    ...
    ltr: function() {
      return new Style().wrapSelector(function(selector) {
        return "[dir='ltr'] " + selector + ", [dir='ltr']" + selector;
      });
    },
    rtl: function() {
      return new Style().wrapSelector(function(selector) {
        return "[dir='rtl'] " + selector + ", [dir='rtl']" + selector;
      });
    },
  ...
  },
  {
    ...
    properties: {
      ...
      "--tw-ring-color": function(theme) {
        var _a;
        return "rgba(" + ((_a = hex2RGB(theme("ringColor.DEFAULT", "#93C5FD"))) === null || _a === void 0 ? void 0 : _a.join(", ")) + ", " + theme("ringOpacity.DEFAULT", "0.5") + ")";
      },
...
function gridTemplate(utility, _a) {
  ...
  }).createProperty("grid-template-" + type, function(value) {
    return value === "none" ? "none" : value;
  })) === null || _b === void 0 ? void 0 : _b.updateMeta("utilities", group, pluginOrder[group], 1, true)) || ((_c = utility.handler.handleNumber(1, void 0, "int").handleVariable().createProperty("grid-template-" + type, function(value) {
...
function gridAuto(utility, _a) {
  ...
  if (value) {
    ...
    return new Style(utility.class, prefixer.map(function(i) {
      return new Property("grid-auto-" + type, i);
...
function border(utility, _a) {
  ...
  var borderColor = (_c = utility.handler.handleColor(theme("borderColor")).handleOpacity(theme("borderOpacity")).handleSquareBrackets(notNumberLead).handleVariable(function(variable) {
    return utility.raw.startsWith("border-$") ? "var(--" + variable + ")" : void 0;
...
function divide(utility, _a) {
  ...
  var divideColor = (_c = utility.handler.handleColor(theme("divideColor")).handleOpacity(theme("divideOpacity")).handleVariable(function(variable) {
    return utility.raw.startsWith("divide-$") ? "var(--" + variable + ")" : void 0;
...
function ring(utility, utils) {
  ...
  var ringColor = (_b = utility.handler.handleColor(utils.theme("ringColor")).handleOpacity(utils.theme("ringOpacity")).handleSquareBrackets(notNumberLead).handleVariable(function(variable) {
    return utility.raw.startsWith("ring-$") ? "var(--" + variable + ")" : void 0;
...
function dropShadow(utility, _a) {
  ...
  if (value)
    return new Property("--tw-drop-shadow", Array.isArray(value) ? value.map(function(i) {
      return "drop-shadow(" + i + ")";
    }).join(" ") : "drop-shadow(" + value + ")").updateMeta("utilities", "dropShadow", pluginOrder.dropShadow, 1, true);
}
  ...
  if (Object.keys(animations).includes(body)) {
    ...
    if (styles) {
      return __spreadArray(__spreadArray([], styles.map(function(i) {
        return i.updateMeta("utilities", "animation", pluginOrder.animation, 2, true);
      })), keyframe ? Keyframes.generate(keyframe, (_f = theme("keyframes." + keyframe)) !== null && _f !== void 0 ? _f : {}, void 0, config("prefixer", false)).map(function(i) {
...
function translate(utility, _a) {
  ...
  if (centerMatch) {
    ...
    return (_b = utility.handler.handleStatic(theme("translate")).handleSquareBrackets().handleSpacing().handleFraction().handleSize().handleNegative().handleVariable().createProperty("--tw-translate-" + center)) === null || _b === void 0 ? void 0 : _b.updateMeta("utilities", "translate", pluginOrder.translate, utility.raw.charAt(0) === "-" ? 2 : 1, true);
  }
}
function skew(utility, _a) {
  ...
  if (centerMatch) {
    ...
    return (_b = utility.handler.handleStatic(theme("skew")).handleSquareBrackets().handleNumber(0, void 0, "float", function(number) {
      return number + "deg";
    }).handleNegative().handleVariable().createProperty("--tw-skew-" + center)) === null || _b === void 0 ? void 0 : _b.updateMeta("utilities", "skew", pluginOrder.skew, utility.raw.charAt(0) === "-" ? 2 : 1, true);
  }
}
...
function outline(utility, _a) {
  ...
  var handler = utility.handler.handleColor().handleOpacity(theme("opacity")).handleSquareBrackets().handleVariable(function(variable) {
    return utility.raw.startsWith("outline-$") ? "var(--" + variable + ")" : void 0;
  });
  ...
  return function(utility, value, color) {
    var handler = {
      ...
      handleStatic: handlers.static ? function(map, callback) {
        ...
        if (map && typeof map === "object") {
          ...
          if (handler._amount in knownMap)
            handler.value = callback ? callback(handler._amount) : "" + knownMap[handler._amount];
        }
        return handler;
      } : function() {
        return handler;
      ...
      createColorStyle: function(selector, property, opacityVariable, wrapRGB) {
        ...
        if (handler.color) {
          var value_2 = handler.color({ opacityVariable, opacityValue: opacityVariable ? "var(" + opacityVariable + ")" : void 0 });
          if (opacityVariable) {
...
var Processor = function() {
  ...
  Processor2.prototype._addPluginProcessorCache = function(type, key, styles) {
    ...
    this._plugin[type][key] = key in this._plugin[type] ? __spreadArray(__spreadArray([], this._plugin[type][key]), styles) : styles;
  };
  ...
  Processor2.prototype.attributify = function(attrs, ignoreProcessed) {
    ...
    var _gStyle = function(key2, value2, equal, notAllow, ignoreProcessed2) {
      ...
      var buildSelector = "[" + _this.e((prefix || "") + key2) + (equal ? "=" : "~=") + '"' + value2 + '"]';
  ...
  Processor2.prototype.addUtilities = function(utilities, options) {
    ...
    var _loop_4 = function(key2, value2) {
      var styles = Style.generate(key2.startsWith(".") && options.respectPrefix ? this_2.prefix(key2) : key2, value2);
      if (options.layer)
        styles.forEach(function(style) {
  ...
  Processor2.prototype.addComponents = function(components, options) {
    ...
    var _loop_5 = function(key2, value2) {
      var styles = Style.generate(key2.startsWith(".") && options.respectPrefix ? this_3.prefix(key2) : key2, value2);
      styles.forEach(function(style) {
        return style.updateMeta(layer, "plugin", order2, ++_this._cache.count);
      });
  ...
  Processor2.prototype.addBase = function(baseStyles) {
    ...
    for (var _i = 0, _a = Object.entries(baseStyles); _i < _a.length; _i++) {
      var _b = _a[_i], key = _b[0], value = _b[1];
      var styles = Style.generate(key, value).map(function(i) {
