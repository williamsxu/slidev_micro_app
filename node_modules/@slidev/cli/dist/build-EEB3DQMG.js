...
async function build(options, viteConfig = {}) {
  ...
  await _fsextra2.default.writeFile(indexPath, await _chunkSDD5H73Qjs.getIndexHtml.call(void 0, options), "utf-8");
  let config = void 0;
  try {
    const inlineConfig = _vite.mergeConfig.call(void 0, viteConfig, {
      plugins: [
        await _chunkSDD5H73Qjs.ViteSlidevPlugin.call(void 0, options, pluginOptions),
        {
          name: "resolve-config",
