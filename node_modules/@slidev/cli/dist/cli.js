...
var _chunkFNO4KBRZjs = require('./chunk-FNO4KBRZ.js');
...
var _chunk7F6CM4HLjs = require('./chunk-7F6CM4HL.js');


var _chunkSDD5H73Qjs = require('./chunk-SDD5H73Q.js');
...
var import_fast_deep_equal = _chunkZKLT77C5js.__toModule.call(void 0, _chunkSDD5H73Qjs.require_fast_deep_equal.call(void 0, ));
...
var cli = _yargs2.default.scriptName("slidev").usage("$0 [args]").version(_chunk7F6CM4HLjs.version).strict().showHelpOnFail(false).alias("h", "help").alias("v", "version");
cli.command("* [entry]", "Start a local server for Slidev", (args) => commonOptions(args).option("port", {
  ...
  async function initServer() {
    if (server)
      await server.close();
    const options = await _chunk7F6CM4HLjs.resolveOptions.call(void 0, { entry, theme }, "dev");
    port = userPort || await findFreePort(3030);
    server = await _chunkFNO4KBRZjs.createServer.call(void 0, options, {
      server: {
        port,
        strictPort: true,
        open,
      ...
      onDataReload(newData, data) {
        if (!theme && _chunk7F6CM4HLjs.resolveThemeName.call(void 0, newData.config.theme) !== _chunk7F6CM4HLjs.resolveThemeName.call(void 0, data.config.theme)) {
...
cli.command("build [entry]", "Build hostable SPA", (args) => commonOptions(args).option("watch", {
  ...
  const { build } = await Promise.resolve().then(() => _chunkZKLT77C5js.__toModule.call(void 0, _chunkZKLT77C5js.__require.call(void 0, "./build-EEB3DQMG.js")));
  const options = await _chunk7F6CM4HLjs.resolveOptions.call(void 0, { entry, theme }, "build");
...
cli.command("theme [subcommand]", "Theme related operations", (command) => {
  return command.command("eject", "Eject current theme into local file system", (args) => commonOptions(args).option("dir", {
    ...
    const data = await _fs.load.call(void 0, entry);
    const theme = _chunk7F6CM4HLjs.resolveThemeName.call(void 0, themeInput || data.config.theme);
    if (theme === "none") {
      console.error('Can not eject theme "none"');
      process.exit(1);
    }
    if (_chunk7F6CM4HLjs.isPath.call(void 0, theme)) {
      console.error("Theme is already ejected");
      process.exit(1);
    }
    const roots = _chunk7F6CM4HLjs.getThemeRoots.call(void 0, theme, entry);
    if (!roots.length) {
...
cli.command("export [entry]", "Export slides to PDF", (args) => commonOptions(args).option("output", {
  ...
  const { exportSlides } = await Promise.resolve().then(() => _chunkZKLT77C5js.__toModule.call(void 0, _chunkZKLT77C5js.__require.call(void 0, "./export-VVWDKB7L.js")));
  const port = await findFreePort(12445);
  const options = await _chunk7F6CM4HLjs.resolveOptions.call(void 0, { entry, theme }, "build");
  const server = await _chunkFNO4KBRZjs.createServer.call(void 0, options, {
    server: { port },
    logLevel: "error",
    clearScreen: false
  });
...
function printInfo(options, port, remote) {
  ...
  console.log(`${_kolorist.bold.call(void 0, "  Slidev")}  ${_kolorist.blue.call(void 0, `v${_chunk7F6CM4HLjs.version}`)} ${_isinstalledglobally2.default ? _kolorist.yellow.call(void 0, "(global)") : ""}`);
  console.log();
