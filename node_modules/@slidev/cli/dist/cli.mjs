...
import {
  ...
  resolveThemeName,
  version
} from "./chunk-GQ7KPLOY.mjs";
import {
  require_fast_deep_equal
} from "./chunk-M7QVPBKQ.mjs";
import {
  __require,
  __toModule
...
cli.command("build [entry]", "Build hostable SPA", (args) => commonOptions(args).option("watch", {
  ...
  const { build } = await Promise.resolve().then(() => __toModule(__require("./build-3CQBIZO4.mjs")));
...
cli.command("export [entry]", "Export slides to PDF", (args) => commonOptions(args).option("output", {
  ...
  const { exportSlides } = await Promise.resolve().then(() => __toModule(__require("./export-VGQEKOSQ.mjs")));
