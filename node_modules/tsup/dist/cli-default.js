...
var require_lib = __commonJS({
  "node_modules/acorn-dynamic-import/lib/index.js"(exports2) {
    init_cjs_shims();
    "use strict";
...
var require_regjsgen = __commonJS({
  "node_modules/regjsgen/regjsgen.js"(exports2, module2) {
    init_cjs_shims();
    (function() {
      "use strict";
      var objectTypes = {
      ...
      var freeExports = objectTypes[typeof exports2] && exports2 && !exports2.nodeType && exports2;
...
var require_parser = __commonJS({
  "node_modules/regjsparser/parser.js"(exports2, module2) {
    init_cjs_shims();
    (function() {
...
var require_regenerate = __commonJS({
  "node_modules/regenerate/regenerate.js"(exports2, module2) {
    init_cjs_shims();
    (function(root) {
...
var require_unicode_canonical_property_names_ecmascript = __commonJS({
  "node_modules/unicode-canonical-property-names-ecmascript/index.js"(exports2, module2) {
    init_cjs_shims();
...
var require_unicode_property_aliases_ecmascript = __commonJS({
  "node_modules/unicode-property-aliases-ecmascript/index.js"(exports2, module2) {
    init_cjs_shims();
...
var require_unicode_match_property_ecmascript = __commonJS({
  "node_modules/unicode-match-property-ecmascript/index.js"(exports2, module2) {
    init_cjs_shims();
    "use strict";
...
var require_mappings = __commonJS({
  "node_modules/unicode-match-property-value-ecmascript/data/mappings.js"(exports2, module2) {
    init_cjs_shims();
    module2.exports = new Map([
...
var require_unicode_match_property_value_ecmascript = __commonJS({
  "node_modules/unicode-match-property-value-ecmascript/index.js"(exports2, module2) {
    init_cjs_shims();
    "use strict";
...
var require_iu_mappings = __commonJS({
  "node_modules/regexpu-core/data/iu-mappings.js"(exports2, module2) {
    init_cjs_shims();
    module2.exports = new Map([
      [75, 8490],
      [83, 383],
...
var require_character_class_escape_sets = __commonJS({
  "node_modules/regexpu-core/data/character-class-escape-sets.js"(exports2) {
    init_cjs_shims();
    "use strict";
    var regenerate = require_regenerate();
    exports2.REGULAR = new Map([
    ...
    exports2.UNICODE_IGNORE_CASE = new Map([
      ["d", regenerate().addRange(48, 57)],
      ["D", regenerate().addRange(0, 47).addRange(58, 1114111)],
      ["s", regenerate(32, 160, 5760, 8239, 8287, 12288, 65279).addRange(9, 13).addRange(8192, 8202).addRange(8232, 8233)],
      ["S", regenerate().addRange(0, 8).addRange(14, 31).addRange(33, 159).addRange(161, 5759).addRange(5761, 8191).addRange(8203, 8231).addRange(8234, 8238).addRange(8240, 8286).addRange(8288, 12287).addRange(12289, 65278).addRange(65280, 1114111)],
...
var require_rewrite_pattern = __commonJS({
  "node_modules/regexpu-core/rewrite-pattern.js"(exports2, module2) {
    init_cjs_shims();
    "use strict";
...
var require_buble_cjs = __commonJS({
  "node_modules/buble/dist/buble.cjs.js"(exports2) {
    init_cjs_shims();
    "use strict";
...
// src/utils.ts
function getBabel() {
  const p = import_resolve_from.default.silent(process.cwd(), "@babel/core");
  return p && require(p);
}
function getPostcss() {
  const p = import_resolve_from.default.silent(process.cwd(), "postcss");
  return p && require(p);
}
function localRequire(moduleName) {
  const p = import_resolve_from.default.silent(process.cwd(), moduleName);
  return p && require(p);
}
...
var import_fs, import_globby, import_resolve_from;
var init_utils = __esm({
  "src/utils.ts"() {
    init_cjs_shims();
    import_fs = __toModule(require("fs"));
    import_globby = __toModule(require("globby"));
    import_resolve_from = __toModule(require("resolve-from"));
  }
});
...
function loadTsConfig(cwd) {
  return joycon.load(["tsconfig.build.json", "tsconfig.json"], cwd, import_path.default.dirname(cwd));
}
...
async function bundleConfig(configFile) {
  const { build: build2 } = await Promise.resolve().then(() => __toModule(require("esbuild")));
      ...
      plugins: [
        {
          ...
          setup(build3) {
            build3.onResolve({ filter: /.*/ }, (args) => {
              if (!import_path.default.isAbsolute(args.path) && !/^[\.\/]/.test(args.path)) {
                return { external: true };
              }
            });
            build3.onLoad({ filter: /\.(js|ts|mjs|cjs|jsx|tsx)$/ }, async (args) => {
              const contents = await import_fs2.default.promises.readFile(args.path, "utf8");
              const ext = import_path.default.extname(args.path);
              return {
                contents: contents.replace(/\b__dirname\b/g, JSON.stringify(import_path.default.dirname(args.path))).replace(/\b__filename\b/g, JSON.stringify(args.path)).replace(/\bimport\.meta\.url\b/g, JSON.stringify(`file://${args.path}`)),
...
async function loadPkg(cwd) {
  const { data } = await joycon.load(["package.json"], cwd, import_path.default.dirname(cwd));
  return data || {};
}
...
var import_fs2, import_parse, import_joycon, import_path, import_strip_json_comments, joycon, loadJson, jsonLoader;
var init_load = __esm({
  "src/load.ts"() {
    init_cjs_shims();
    import_fs2 = __toModule(require("fs"));
    import_parse = __toModule(require_parse());
    import_joycon = __toModule(require("joycon"));
    import_path = __toModule(require("path"));
    import_strip_json_comments = __toModule(require_strip_json_comments());
    joycon = new import_joycon.default();
    loadJson = async (filepath) => {
      try {
        const content = (0, import_strip_json_comments.default)(await import_fs2.default.promises.readFile(filepath, "utf8"));
...
var import_fs3, import_path2, postcssPlugin;
      ...
      return {
        ...
        setup(build2) {
          ...
          const getPostcssConfig = async (file) => {
            ...
            try {
              const result = await loadConfig({}, import_path2.default.dirname(file));
          ...
          build2.onLoad({ filter: /\.css$/ }, async (args) => {
            ...
            if (css && args.path.endsWith(".svelte.css")) {
              ...
              contents = await import_fs3.default.promises.readFile(args.path, "utf8");
            }
            ...
            const result = await (postcss == null ? void 0 : postcss.default(plugins).process(contents, __spreadProps(__spreadValues({}, options), { from: args.path })));
            return {
              contents: result.css,
              loader: "css"
            };
...
var NON_NODE_MODULE_RE, externalPlugin;
...
var import_fs4, import_path3, useSvelteCssExtension, sveltePlugin;
var init_svelte = __esm({
  "src/esbuild/svelte.ts"() {
    ...
    init_utils();
    useSvelteCssExtension = (p) => p.replace(/\.svelte$/, ".svelte.css");
    sveltePlugin = ({
      css
    }) => {
      return {
        ...
        setup(build2) {
          ...
          build2.onResolve({ filter: /\.svelte\.css$/ }, (args) => {
            return {
              path: import_path3.default.relative(process.cwd(), import_path3.default.join(args.resolveDir, args.path)),
          ...
          build2.onLoad({ filter: /\.svelte$/ }, async (args) => {
            ...
            let source = await import_fs4.default.promises.readFile(args.path, "utf8");
            let filename = import_path3.default.relative(process.cwd(), args.path);
            try {
              ...
              if (css && result.css) {
                ...
                contents = `import '${useSvelteCssExtension(import_path3.default.basename(args.path))}';` + contents;
              }
...
var import_chalk2, makeLabel, silent;
var init_log = __esm({
  "src/log.ts"() {
    init_cjs_shims();
    import_chalk2 = __toModule(require("chalk"));
    makeLabel = (input, type) => import_chalk2.default[type === "info" ? "bgBlue" : type === "error" ? "bgRed" : "bgGreen"](import_chalk2.default.black(` ${input.toUpperCase()} `));
    silent = false;
  }
});
...
async function runEsbuild(options, { format, css }) {
  ...
  try {
    result = await (0, import_esbuild.build)({
      ...
      define: __spreadValues(__spreadValues(__spreadValues({}, format === "cjs" ? {
        "import.meta.url": "importMetaUrlShim"
      } : {}), options.define), Object.keys(env).reduce((res2, key) => {
        const value = JSON.stringify(env[key]);
        return __spreadProps(__spreadValues({}, res2), {
  ...
  if (result && result.warnings) {
    ...
    const formatted = await (0, import_esbuild.formatMessages)(messages, {
      kind: "warning",
      color: true
    });
  ...
  if (result && result.outputFiles) {
    ...
    await Promise.all(result.outputFiles.map(async (file) => {
      const dir = (0, import_path4.dirname)(file.path);
      const outPath = file.path;
      const ext = (0, import_path4.extname)(outPath);
      ...
      if (comeFromSource) {
        if (options.babel) {
          ...
          if (babel) {
            ...
            throw new PrettyError(`@babel/core is not found in ${process.cwd()}`);
          }
        }
        if (options.target === "es5") {
          try {
            ...
            throw new PrettyError(`Error compiling to es5 target:
${error.snippet}`);
          }
        }
        if (splitting && format === "cjs") {
          contents = (0, import_sucrase.transform)(contents, {
            filePath: file.path,
            transforms: ["imports"]
          }).code;
        }
      }
      await import_fs5.default.promises.writeFile(outPath, contents, {
        encoding: "utf8",
        mode
      });
    }));
...
async function build(_options) {
  ...
  const buildAll = async () => {
    ...
    if (options.onSuccess) {
      ...
      existingOnSuccess = (0, import_execa.default)(exec, args, {
        stdio: "inherit"
      });
    }
  };
  const startWatcher = async () => {
    if (!options.watch)
      return;
    const { watch } = await Promise.resolve().then(() => __toModule(require("chokidar")));
    ...
    const watchPaths = typeof options.watch === "boolean" ? "." : Array.isArray(options.watch) ? options.watch.filter((path5) => typeof path5 === "string") : options.watch;
    log("CLI", "info", `Watching for changes in ${Array.isArray(watchPaths) ? watchPaths.map((v) => '"' + v + '"').join(" | ") : '"' + watchPaths + '"'}`);
    log("CLI", "info", `Ignoring changes in ${ignored.map((v) => '"' + v + '"').join(" | ")}`);
  ...
  startWatcher();
  if (options.dts) {
    const hasTypescript = import_resolve_from2.default.silent(process.cwd(), "typescript");
    if (!hasTypescript) {
      throw new Error(`You need to install "typescript" in your project`);
    }
    const isDev = __filename.endsWith("index.ts");
    const worker = new import_worker_threads2.Worker((0, import_path4.join)(__dirname, isDev ? "./rollup.dev.js" : "./rollup.js"));
    worker.postMessage({
...
var import_fs5, import_path4, import_worker_threads2, import_buble, import_esbuild, import_globby2, import_resolve_from2, import_string_argv, import_execa, import_consola, import_tree_kill, import_sucrase, getOutputExtensionMap, defineConfig, killProcess, normalizeOptions;
var init_src = __esm({
  "src/index.ts"() {
    init_cjs_shims();
    import_fs5 = __toModule(require("fs"));
    import_path4 = __toModule(require("path"));
    import_worker_threads2 = __toModule(require("worker_threads"));
    import_buble = __toModule(require_buble_cjs());
    import_esbuild = __toModule(require("esbuild"));
    init_utils();
    init_load();
    import_globby2 = __toModule(require("globby"));
    init_errors();
    init_postcss();
    init_external();
    init_svelte();
    import_resolve_from2 = __toModule(require("resolve-from"));
    import_string_argv = __toModule(require_string_argv());
    import_execa = __toModule(require("execa"));
    import_consola = __toModule(require_consola());
    import_tree_kill = __toModule(require("tree-kill"));
    import_sucrase = __toModule(require("sucrase"));
    init_package();
    init_log();
    getOutputExtensionMap = (pkgTypeField, format) => {
    ...
    killProcess = ({
      ...
      (0, import_tree_kill.default)(pid, signal, resolve);
    });
    normalizeOptions = async (optionsFromConfigFile, optionsOverride) => {
      var _a, _b;
      const options = __spreadValues(__spreadValues({}, optionsFromConfigFile), optionsOverride);
      setSilent(options.silent);
      const input = options.entryPoints;
      if (input) {
        options.entryPoints = await (0, import_globby2.default)(input);
      } else {
...
async function main(options = {}) {
  const cli = (0, import_cac.cac)("tsup");
  ...
  cli.help();
  const pkgPath = (0, import_path5.join)(__dirname, "../package.json");
  cli.version(JSON.parse((0, import_fs6.readFileSync)(pkgPath, "utf8")).version);
