...
var import_worker_threads2 = __toModule(require("worker_threads"));
...
var import_resolve_from = __toModule(require("resolve-from"));
function getBabel() {
...
// src/index.ts
var import_resolve_from2 = __toModule(require("resolve-from"));
...
var makeLabel = (input, type) => import_chalk2.default[type === "info" ? "bgBlue" : type === "error" ? "bgRed" : "bgGreen"](import_chalk2.default.black(` ${input.toUpperCase()} `));
var silent = false;
