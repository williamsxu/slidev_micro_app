...
var require_vlq = __commonJS({
  "node_modules/vlq/dist/vlq.js"(exports2, module2) {
    init_cjs_shims();
...
var require_magic_string_cjs = __commonJS({
  "node_modules/rollup-plugin-hashbang/node_modules/magic-string/dist/magic-string.cjs.js"(exports2, module2) {
    init_cjs_shims();
    "use strict";
    var vlq = require_vlq();
    ...
    module2.exports = MagicString$1;
  }
});

// node_modules/rollup-plugin-hashbang/dist/index.js
var require_dist = __commonJS({
  "node_modules/rollup-plugin-hashbang/dist/index.js"(exports2, module2) {
    init_cjs_shims();
    "use strict";
...
var require_cjs = __commonJS({
  "node_modules/@rollup/pluginutils/dist/cjs/index.js"(exports2) {
    init_cjs_shims();
    "use strict";
    ...
    function getMatcherString(id, resolutionBase) {
      ...
      const basePath = path3.resolve(resolutionBase || "").split(path3.sep).join("/").replace(/[-^$*+?.()|[\]{}]/g, "\\$&");
      return path3.posix.join(basePath, id);
    }
    var createFilter = function createFilter2(include, exclude, options) {
      ...
      return function result(id) {
        ...
        if (/\0/.test(id))
          return false;
        const pathId = id.split(path3.sep).join("/");
...
var require_dist2 = __commonJS({
  "node_modules/@rollup/plugin-json/dist/index.js"(exports2, module2) {
    init_cjs_shims();
    "use strict";
...
var require_sourcemap_codec_umd = __commonJS({
  "node_modules/sourcemap-codec/dist/sourcemap-codec.umd.js"(exports2, module2) {
    init_cjs_shims();
    (function(global, factory) {
      typeof exports2 === "object" && typeof module2 !== "undefined" ? factory(exports2) : typeof define === "function" && define.amd ? define(["exports"], factory) : (global = global || self, factory(global.sourcemapCodec = {}));
    })(exports2, function(exports3) {
      "use strict";
      var charToInteger = {};
...
var require_magic_string_cjs2 = __commonJS({
...
var require_rollup_plugin_dts = __commonJS({
  "node_modules/rollup-plugin-dts/dist/rollup-plugin-dts.cjs"(exports2) {
    init_cjs_shims();
    "use strict";
    Object.defineProperty(exports2, "__esModule", { value: true });
    var path3 = require("path");
    ...
    var MagicString = require_magic_string_cjs2();
    ...
    function getCompilerOptions(input, overrideOptions) {
      const compilerOptions = __spreadValues(__spreadValues({}, overrideOptions), OPTIONS_OVERRIDE);
      ...
      return {
        dtsFiles,
        dirName,
        compilerOptions: __spreadValues(__spreadValues({}, options), compilerOptions)
      };
    }
    ...
    var plugin = (options = {}) => {
      ...
      return {
        ...
        transform(code, id) {
          ...
          let module3 = getModule(declarationId);
          if (module3.source) {
            return transformFile(module3.source, declarationId);
          }
          module3 = getModule(id);
          if (typeof module3.source != "object" || !module3.program) {
            return null;
          }
          let generated;
          const { emitSkipped, diagnostics } = module3.program.emit(module3.source, (_, declarationText) => {
...
var import_rollup_plugin_hashbang = __toModule(require_dist());
var import_plugin_json = __toModule(require_dist2());
...
var import_resolve = __toModule(require_resolve());
var import_debug = __toModule(require("debug"));
var import_module = __toModule(require("module"));
var debug = (0, import_debug.default)("tsup:ts-resolve");
...
var tsResolvePlugin = ({
  ...
  return {
    ...
    async resolveId(source, importer) {
      ...
      if (/\0/.test(source))
        return null;
      if (import_module.builtinModules.includes(source))
        return false;
      ...
      if (import_path.default.isAbsolute(source))
        return null;
      const basedir = importer ? import_path.default.dirname(importer) : process.cwd();
      if (source[0] === ".") {
...
var import_parse = __toModule(require_parse2());
...
var loadJson = async (filepath) => {
  try {
    ...
    throw new Error(`Failed to parse ${import_path2.default.relative(process.cwd(), filepath)}: ${error.message}`);
  }
};
var jsonLoader = {
  test: /\.json$/,
...
function loadTsConfig(cwd) {
  return joycon.load(["tsconfig.build.json", "tsconfig.json"], cwd, import_path2.default.dirname(cwd));
}
async function loadPkg(cwd) {
  const { data } = await joycon.load(["package.json"], cwd, import_path2.default.dirname(cwd));
  return data || {};
}
...
var getRollupConfig = async (options) => {
  ...
  const compilerOptions = await loadTsConfig(process.cwd()).then((res) => {
    var _a2;
    return ((_a2 = res.data) == null ? void 0 : _a2.compilerOptions) || {};
  });
  const dtsOptions = typeof options.dts === "string" ? { entry: options.dts } : options.dts === true ? { entry: options.entryPoints } : __spreadValues({ entry: options.entryPoints }, options.dts);
...
async function runRollup(options) {
  var _a2;
  const { rollup } = await Promise.resolve().then(() => __toModule(require("rollup")));
  try {
    ...
    (_a2 = import_worker_threads2.parentPort) == null ? void 0 : _a2.postMessage("error");
    handleError(error);
  }
}
async function watchRollup(options) {
  const { watch } = await Promise.resolve().then(() => __toModule(require("rollup")));
  watch(__spreadProps(__spreadValues({}, options.inputConfig), {
    ...
    if (event.code === "START") {
      ...
      (_a2 = import_worker_threads2.parentPort) == null ? void 0 : _a2.postMessage("success");
    } else if (event.code === "ERROR") {
      log("dts", "error", "Build failed");
      (_b = import_worker_threads2.parentPort) == null ? void 0 : _b.postMessage("error");
...
var startRollup = async (options) => {
  ...
  if (options.watch) {
    ...
    (_a2 = import_worker_threads2.parentPort) == null ? void 0 : _a2.close();
  }
};
var _a;
(_a = import_worker_threads2.parentPort) == null ? void 0 : _a.on("message", (data) => {
