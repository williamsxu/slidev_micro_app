...
var _chunkB3CRUP5Kjs = require('./chunk-B3CRUP5K.js');
...
var require_compare_versions = _chunk7T67WII5js.__commonJS.call(void 0, {
...
function getStyleDir(compName) {
  ...
  if (!styleDir)
    styleDir = _chunkB3CRUP5Kjs.kebabCase.call(void 0, compName);
  return styleDir;
}
...
_chunk7T67WII5js.init_cjs_shims.call(void 0, );
var import_compare_versions = _chunk7T67WII5js.__toModule.call(void 0, require_compare_versions());
...
function ElementPlusResolver(options = {}) {
  return (name) => {
    if (name.match(/^El[A-Z]/)) {
      const {
        version = _chunkB3CRUP5Kjs.getPkgVersion.call(void 0, "element-plus", "1.0.2")
      } = options;
      const partialName = _chunkB3CRUP5Kjs.kebabCase.call(void 0, name.slice(2));
...
function ElementUiResolver(options = {}) {
  return (name) => {
    if (name.startsWith("El")) {
      ...
      const partialName = _chunkB3CRUP5Kjs.kebabCase.call(void 0, compName);
      return {
...
function IduxResolver(options = {}) {
  return (name) => {
    if (name.match(/^Ix[A-Z]/)) {
      ...
      const compName = name.slice(2);
      const kebabCaseName = _chunkB3CRUP5Kjs.kebabCase.call(void 0, compName);
  ...
  return (name) => {
    ...
    if (name.startsWith("Van")) {
      ...
      return {
        ...
        path: "vant/es",
        sideEffects: importStyle ? `vant/es/${_chunkB3CRUP5Kjs.kebabCase.call(void 0, partialName)}/style` : void 0
      };
    }
  };
}
  ...
  return (name) => {
    ...
    if (name.startsWith("Var")) {
      ...
      if (importStyle || importCss) {
        if (importStyle === "less" || importLess)
          sideEffects.push(`@varlet/ui/es/${_chunkB3CRUP5Kjs.kebabCase.call(void 0, partialName)}/style/less.js`);
        else
          sideEffects.push(`@varlet/ui/es/${_chunkB3CRUP5Kjs.kebabCase.call(void 0, partialName)}/style`);
      }
      return {
...
function VeuiResolver(options) {
  ...
  if (!components3) {
    try {
      const componentsData = _chunk7T67WII5js.__require.call(void 0, `${alias}/components.json`);
...
var formatters = {
  "kebab-case": _chunkB3CRUP5Kjs.kebabCase,
  "camelCase": _chunkB3CRUP5Kjs.camelCase,
  "PascalCase": _chunkB3CRUP5Kjs.pascalCase
};
var peerPaths = new Map();
function assertPeerPath(peerPath) {
  if (!peerPaths.has(peerPath)) {
    try {
      _chunkB3CRUP5Kjs.resolveImportPath.call(void 0, peerPath);
...
function getCompDir(compName) {
  ...
  for (let i = 0; i < total; i++) {
    ...
    if (compName.match(matcher.pattern)) {
      compPath = `${matcher.compDir}/${_chunkB3CRUP5Kjs.kebabCase.call(void 0, compName)}.vue`;
      break;
    }
  }
  if (!compPath)
    compPath = _chunkB3CRUP5Kjs.kebabCase.call(void 0, compName);
  return compPath;
}
...
function VueUseComponentsResolver() {
  return (name) => {
    if (!components4) {
      try {
        const indexesJson = _chunk7T67WII5js.__require.call(void 0, "@vueuse/core/indexes.json");
...
function QuasarResolver() {
  return (name) => {
    let components5 = [];
    try {
      components5 = _chunk7T67WII5js.__require.call(void 0, "quasar/dist/transforms/api-list.json");
    } catch (e) {
    }
...
exports.AntDesignVueResolver = AntDesignVueResolver; exports.ElementPlusResolver = ElementPlusResolver; exports.ElementUiResolver = ElementUiResolver; exports.HeadlessUiResolver = HeadlessUiResolver; exports.IduxResolver = IduxResolver; exports.LibraryResolver = _chunkB3CRUP5Kjs.LibraryResolver; exports.NaiveUiResolver = NaiveUiResolver; exports.PrimeVueResolver = PrimeVueResolver; exports.QuasarResolver = QuasarResolver; exports.VantResolver = VantResolver; exports.VarletUIResolver = VarletUIResolver; exports.VeuiResolver = VeuiResolver; exports.ViewUiResolver = ViewUiResolver; exports.VueUseComponentsResolver = VueUseComponentsResolver; exports.VuetifyResolver = VuetifyResolver; exports.tryLoadVeturTags = _chunkB3CRUP5Kjs.tryLoadVeturTags;
