...
var import_pathe = __toModule(require("pathe"));
var import_webpack_virtual_modules = __toModule(require("webpack-virtual-modules"));
var _dirname = typeof __dirname !== "undefined" ? __dirname : (0, import_pathe.dirname)((0, import_url.fileURLToPath)(importMetaUrlShim));
var TRANSFORM_LOADER = (0, import_pathe.resolve)(_dirname, "webpack/loaders/transform.js");
var LOAD_LOADER = (0, import_pathe.resolve)(_dirname, "webpack/loaders/load.js");
    ...
    return {
      apply(compiler) {
        ...
        const plugin = Object.assign(rawPlugin, {
          __unpluginMeta: meta,
          __virtualModulePrefix: (0, import_pathe.join)(process.cwd(), "virtual:")
        });
